...
from sqlalchemy import Boolean, Date, DateTime, ForeignKey, Index, LargeBinary, String, func, text
...
class Client(CRMBaseModel):
    ...
    documents: Mapped[list["Document"]] = relationship(
        "Document", back_populates="client", lazy="selectin",
    )
...
class Document(CRMBaseModel):
    ...
    client: Mapped["Client"] = relationship(
        "Client", foreign_keys=[client_id], back_populates="documents", lazy="selectin",
    )
    ...
    __table_args__ = (
        Index(
            "uq_document_number", "document_number", unique=True,
